  ...
  <div class="content">
    <div class="container">
      ...
      <div class="col-md-8">
        ...
        <button onclick="geek()" class="btn text-white btn-block btn-primary"><strong>Confirmar reserva</strong></button>
...
echo '
  ...
  //if(isset($_SESSION['idcadastro'])) {
      ...
      $contexto = '<strong>Parabéns!</strong><br>'.$nome.', sua locação foi realizada com sucesso!<br> Reserva para ';
      ...
      if ($enviado) { 
        ...
        //echo '<script> alert("Aluguel realizado com sucesso")</script>';
